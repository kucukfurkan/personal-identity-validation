...
export class ValidatorQAT extends BaseValidator {
  ...
  validateNationalIdNumber(value: string): boolean {
    ...
    if (!this.isValidNationalIdDate(value)) return false;
    if (!this.isValidNationalIdCountryCode(value)) return false;
